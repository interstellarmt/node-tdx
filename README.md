...
直连通达信公开行情服务器（端口 `7709`），免费、零鉴权，提供 A 股 K 线、五档盘口、分时、分笔成交、证券列表等数据。

[![npm version](https://img.shields.io/npm/v/node-tdx-market.svg?style=flat-square&color=cb3837&logo=npm)](https://www.npmjs.com/package/node-tdx-market)
[![npm downloads](https://img.shields.io/npm/dm/node-tdx-market.svg?style=flat-square&color=cb3837)](https://www.npmjs.com/package/node-tdx-market)
[![node version](https://img.shields.io/node/v/node-tdx-market.svg?style=flat-square&color=339933&logo=node.js)](https://www.npmjs.com/package/node-tdx-market)
...
[![License: MIT](https://img.shields.io/npm/l/node-tdx-market.svg?style=flat-square&color=blue)](./LICENSE)

</div>

> [!WARNING]
> 本项目仅供**协议研究与个人学习**，不对外提供数据服务，请勿用于商业用途。详见下方 [声明与免责](#声明与免责disclaimer)。

---

## 📑 目录

- [致谢与来源](#致谢与来源attribution)
- [声明与免责](#声明与免责disclaimer)
- [特性](#-特性)
- [目录结构](#目录结构)
- [安装](#安装)
- [快速开始](#快速开始)
...
- 本项目仅用于**网络协议研究与个人学习**，不对外提供任何数据服务，也不保证数据的准确性、完整性、实时性或可用性。
- 本项目连接的是**第三方既有的通达信兼容公开行情服务器**，与通达信官方、各券商及任何数据提供方均无关联，服务器的可用性与数据均由对方决定，可能随时变更或失效。
- **请勿用于商业用途或对外提供服务**；机构用户请勿使用。任何使用本项目所产生的风险与后果（包括但不限于因数据错误、延迟、中断导致的投资损失或法律风险）均由使用者自行承担，作者不承担任何责任。
- 使用本项目即表示你已知悉并同意上述条款。如不同意，请勿使用。
